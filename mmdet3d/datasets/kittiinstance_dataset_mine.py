...
class KittiInstanceDataset(Seg3DDataset):
    r"""KittiInstance Dataset.

    This class serves as the API for experiments on the KittiInstance Dataset
    ...
    """
    METAINFO = {
        'classes': ('background', 'foreground', 'motorcycle', 'truck', 'bus', 'person',
