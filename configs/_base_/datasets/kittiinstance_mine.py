...
dataset_type = 'KittiInstanceDataset'
data_root = 'data/kitti_instance_seg/'
class_names = [
    'background', 'foreground', 'motorcycle', 'truck', 'bus', 'person', 'bicyclist',
...
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='kittiinstance_infos_train.pkl',
...
test_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='kittiinstance_infos_val.pkl',
